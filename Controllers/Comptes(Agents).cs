...
namespace InterventionAPI.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class Comptes : ControllerBase
    {
        private readonly Learn_DBContext context;
        private readonly JWTSetting setting;
        private readonly Login tokenGenerator;
        public Comptes(Learn_DBContext learn_DB, IOptions<JWTSetting> options, Login _refreshToken)
        {
            context = learn_DB;
